...
- **Descriptive Statistics:**
    - Average transaction value: $456, with a median of $135, indicating a right-skewed distribution.
    -  Mode: $50, showing frequent small-value transactions.
    -  High variability (Standard deviation: $560) suggests diverse customer spending habits.

- **Customer & Product Analysis:**
  - 25-54 age group drives the highest revenue (~$97K per segment).
  - Zero purchases from the 65+ age group, presenting an untapped market.
  - Female customers spend slightly more than males ($232K vs. $223K)
  - Electronics ($156,905) & Clothing ($155,580) are top-selling categories, followed by Beauty products ($143,515).
...
3. Do sales tend to increase on specific days of the week (e.g., weekends vs. weekdays)?
4. Is there a general upward or downward trend in sales over time?
5. Which gender contributes the most to total sales?
6. What age group spends the most money?
7. Are there certain customer groups that should be targeted more with promotions?
8. What is the top-selling product categories?
9. Which products generate the highest total revenue?
10. Do certain products sell better in specific months (seasonality analysis)?
